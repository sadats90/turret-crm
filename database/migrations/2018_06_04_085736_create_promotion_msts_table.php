...
class CreatePromotionMstsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('promotion_msts', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('Promotion_Approved_Status')->default('Pending');
    ...
    {
        Schema::dropIfExists('promotion_msts');
    }
}

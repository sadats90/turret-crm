...
<head>
    ...
    <!-- For charts -->
    <!-- Waves Effect Css -->
    <link href="admin_bsb_template/plugins/node-waves/waves.css" rel="stylesheet" />

    <!-- Animation Css -->
    <link href="admin_bsb_template/plugins/animate-css/animate.css" rel="stylesheet" />

    <!-- For tables -->
    <!-- JQuery DataTable Css -->
    <link href="admin_bsb_template/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css" rel="stylesheet">

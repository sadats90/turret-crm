...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">TurretGlobal CRM</a>
            </div>
    ...
    <!-- Jquery Core Js -->
    <script src="{{asset('admin_bsb_template/plugins/jquery/jquery.min.js')}}"></script>
    ...
    <!-- For charts -->
    <!-- Waves Effect Plugin Js -->
    <script src="admin_bsb_template/plugins/node-waves/waves.js"></script>

    <!-- Chart Plugins Js -->
    <script src="admin_bsb_template/plugins/chartjs/Chart.bundle.js"></script>
    <script src="admin_bsb_template/js/pages/charts/chartjs.js"></script>

    <!-- Morris Plugin Js -->
    <script src="admin_bsb_template/plugins/raphael/raphael.min.js"></script>
    <script src="admin_bsb_template/plugins/morrisjs/morris.js"></script>
    <script src="admin_bsb_template/js/pages/charts/morris.js"></script>

    <!-- Flot Chart Plugins Js -->
    <script src="admin_bsb_template/plugins/flot-charts/jquery.flot.js"></script>
    <script src="admin_bsb_template/plugins/flot-charts/jquery.flot.resize.js"></script>
    <script src="admin_bsb_template/plugins/flot-charts/jquery.flot.pie.js"></script>
    <script src="admin_bsb_template/plugins/flot-charts/jquery.flot.categories.js"></script>
    <script src="admin_bsb_template/plugins/flot-charts/jquery.flot.time.js"></script>
    <script src="admin_bsb_template/js/pages/charts/flot.js"></script>

    <!-- For data tables -->
    <!-- Jquery DataTable Plugin Js -->
    <script src="admin_bsb_template/plugins/jquery-datatable/jquery.dataTables.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/skin/bootstrap/js/dataTables.bootstrap.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/buttons.flash.min.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/jszip.min.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/pdfmake.min.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/vfs_fonts.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/buttons.html5.min.js"></script>
    <script src="admin_bsb_template/plugins/jquery-datatable/extensions/export/buttons.print.min.js"></script>

    <!-- Custom Js -->
    <script src="admin_bsb_template/js/pages/tables/jquery-datatable.js"></script>
</body>
